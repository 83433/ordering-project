...
public class PipeChecker {
    ...
    private final boolean insulation, reinforcement, chemicalResistance;
    private final double length;
    private int type = 0;
    
    public PipeChecker(double _length, int _grade, int _noColour, boolean _insul, boolean _reinf, boolean _chemRes){
        grade = _grade;
        length = _length;
        noColours = _noColour;
        insulation = _insul;
        reinforcement = _reinf;
        chemicalResistance = _chemRes;
    }
